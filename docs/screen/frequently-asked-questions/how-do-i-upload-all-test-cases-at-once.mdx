...
description: "HackerRank allows you to upload all test cases for a Coding or Approximate Solution question as a zip file. This feature is particularly useful when dealing wi…"
mode: "custom"
---
...
You can upload the zip file directly on the **Test Cases** tab of a Coding or Approximate Solution question in HackerRank. Refer to the [Create a coding question ](https://support.hackerrank.com/hc/en-us/articles/115006421707)article to understand the detailed steps involved.
