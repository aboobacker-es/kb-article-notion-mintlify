...
<Accordion title="**What is the maximum number of candidates I can assess using coding assessments?**">
You can assess up to 100,000 candidates simultaneously using our coding assessments.
</Accordion>

<Accordion title="**Can I include emojis in the test disclaimer?**">
...
<Accordion title="**Does the invite count drop when reinviting a candidate?**">
...
<Accordion title="**How can I check a candidate’s attempt using their email?**">
...
<Accordion title="**Why can I not send email invites to candidates for a test?**">
...
<Accordion title="**What happens to a candidate's status if the cut-off score is changed?**">
...
<Accordion title="**How do I assess Selenium Skills on HackerRank?**">
...
<Accordion title="**How can I try a question or a test?**">
...
<Accordion title="**How can I rename a test?**">
